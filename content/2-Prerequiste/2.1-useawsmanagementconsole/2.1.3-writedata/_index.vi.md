...
Các bước ghi dữ liệu vào bảng Music(đã tạo ở mục 2.1.2):
...
3. Trong danh sách bảng, hãy chọn bảng **Music**.
...
10.  Lặp lại bước 8 và tạo một mục khác với các giá trị sau:
...
11.  Thực hiện thao tác này một lần nữa để tạo một mục khác có cùng một Artist như bước trước, nhưng các giá trị khác nhau cho các thuộc tính khác:
- **Artist**, nhập **`Acme Band`**.
